      ...
      <div className={styles.hero}>
        ...
        <main>
            <div className={styles.section}>
                <h1>Why Birb</h1>
                <div>
                  <h2>Easy to make command line apps</h2>
                  <p>Eaay to make command line apps in less amount of code and pretty easy to learn if you know any other language</p>
                ...
                <div>
                  ...
                  <div className={styles.Row}>
                    <div className={styles.Card}>
                      ...
                      <p>Install Birb Code VS Code Extension from VS Code Marketplace</p>
                      <div className={styles.buttons}>
            ...
            <h1 align="center">Want to try Birb? Give it a shot!</h1>
